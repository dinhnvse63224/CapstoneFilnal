      ...
      <div class="container">
        <div class="row space-100 justify-content-center">
          <div class="col-lg-12 col-md-12 col-xs-12">
            <div class="contents">
              <h2 class="head-title">TÌM KIẾM VIỆC LÀM </h2>
                        ...
                        <div class="search-category-container">
                          <label class="styled-select">
                            <select v-model="categoryCode">
                              ...
                              <option v-for="(category, index) in listCategories" v-bind:key="index" v-bind:category="category" :value="category.id"> {{category.value}} </option>
                            </select>
                          </label>
                        </div>
