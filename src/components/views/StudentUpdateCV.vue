        ...
        <div class="col-lg-10 col-md-12">
          <div class="card shadow-lg card-1">
            <div class="card-body inner-card">
              <div><a href="#" @click="comeback"> trở về trang hồ sơ</a><br /></div>
        ...
        .catch((e) => {
          ...
          if(status == 500){
            if (
              ...
              this.error_dob.push("Bạn phải điền ngày sinh");
            }
          }
          if (status === 400) {
           /*  this.isError = true; */
           if (this.school.length <= 0) {
            ...
            if (this.desiredSalaryMinimum.length <= 0) {
              this.error_salaryMinimum.push(
                "Mức lương mong muốn không để trống"
              );
            }
            /*Check date of birth*/
            if (
              ...
              this.error_dob.push("Bạn phải trên 16 tuổi");
            }
            /*Check Cv name*/
            if (
              JSON.stringify(
            ...
            /*Check phone number*/
             if (
              ...
              "Phone number length minimum is 8 and maximum is 12"
            ) {
