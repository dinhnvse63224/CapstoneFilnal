            ...
            <div class="breadcrumb-wrapper">
              <div class="content">
                ...
                <div class="tags">
                  ...
                  <br><span style="color: red; font-weight: bold; font-size: 20px;" >*Lưu ý: Bạn phải thanh toán với nội dung: {{job.id}} + {{job.name}} </span>
                  <br><span style="color: red; font-weight" > Bạn phải thanh toán {{job.price}} VNĐ</span>
                  <br><span style="color: red; font-weight" >Số tài khoản: 02491375 </span>
                   <br><span style="color: red; font-weight;" >Ngân Hàng:Tien Phong Bank </span>
                </div>
              </div>
            </div>
          </div>
