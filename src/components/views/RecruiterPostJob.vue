      ...
      <div class="col-lg-10 col-md-12">
        ...
        <div class="card shadow-lg card-1">
          <div class="card-body inner-card">
            <div><a href="#" @click="comeback"> trở về trang quản lý</a><br /></div>
      ...
      axios
        ...
        .then(() => {
          Swal.fire({
            ...
            html: 'Lưu ý: Để được duyệt bài vào trang cá nhân <b>XEM TRƯỚC </b> việc làm trong <b> Việc làm chờ duyệt</b> để được duyêt',
            icon: "success",
         ...
         .catch((e) => {
          ...
          if (status == 400) {
            ...
            if (
              ...
              this.error_salaryMin.push("Mức lương tối thiểu không để trống");
            }
            /*Check working place*/
            if (
              JSON.stringify(
              ...
              this.error_workingPlace.push("Địa chỉ không để trống");
            }
            /*Check working form*/
            if (
              JSON.stringify(
