        ...
        <div class="row">
          <div class="col-lg-12 col-md-6 col-xs-12">
            <div class="breadcrumb-wrapper">
              <div class="content">
                <h3 class="job-title" style="font-weight: bold">{{ job.name }}</h3>
                <p class="brand"></p>
                <div class="tags">
                  <span
      ...
      <div class="container">
        <div class="row justify-content-between">
          ...
          <div class="col-lg-5 col-md-12 col-xs-12">
            ...
            <div class="sideber">
              <div class="widghet" v-show="job.companyName != ''">
                <h3>THÔNG TIN CÔNG TY</h3>
                <li>
                  <label class="job-label" style="font-weight: bold">{{ job.companyName }}</label>
                </li>
                <li v-show="job.companyUrl != '' ">
        ...
        <!--Bạn cần đăng nhập để xem thông tin chi tiết-->
        <div
          class="modal fade"
          id="guestDetailJob"
          tabindex="-1"
        ...
        <!--Bạn đã gửi CV này đến nhà tuyển dụng rồi-->
        <div
          class="modal fade"
          id="studentApplyAlready"
          tabindex="-1"
          aria-labelledby="exampleModalLabel"
          aria-hidden="true"
        >
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <ul class="body-desc">
                  <li>
                    Bạn đã gửi Cv này đến nhà tuyển dụng
                  </li>
                </ul>
                <button
                  @click.prevent="accept"
      ...
      if (this.token) {
        ...
        axios
          ...
          .catch((e) => {
            ...
            console.log(message);
            // eslint-disable-next-line no-undef
            $("#studentApplyAlready").modal("show");
          });
      } else {
      ...
      if (this.token) {
        ...
        axios
          ...
          .catch((e) => {
            ...
            console.log(message);
            // eslint-disable-next-line no-undef
            $("#studentSaveAlready").modal("show");
          });
      } else {
        // eslint-disable-next-line no-undef
        $("#guestSaveJob").modal("show");
      }
    },
    details() {
      // eslint-disable-next-line no-undef
        $("#guestDetailJob").modal("show");
    },
    formatPrice(value) {
