                        ...
                        <div class="card h-100 shadow-sm">
                          ...
                          <div class="card-body">
                            ...
                            <!-- <label class="label"
                              >Trạng thái CV:
                              {{
                                cv.isPublic ? "Đã công khai" : "Đã ẩn"
                              }}</label
                            > -->
                            <label class="label" v-if="cv.isPublic == true" style="color: green; font-weight: bold">
                              Trạng thái: Đã công khai
                            </label>
                             <label class="label" v-else style="color: red; font-weight: bold" >
                              Trạng thái: Đã ẩn
                            </label>
                            <!-- <div class="text-center my-4">
                              Công khai CV: <button
                                class="ui button big"
                                :class="[isPublic ? 'green' : 'red']"
                                @click="toggle"
                              >
                                {{ isPublic ? "Bật" : "Tắt" }}
                              </button>
                            ...
                            <div class="text-center my-4">
                              ...
                              <!-- <button
                                class="btn btn-warning"
                                @click.prevent="modalHideCV(cv.id)"
                              >
                                Ẩn CV
                              </button>
                              <button
                                class="btn btn-warning"
                                @click.prevent="modalShowCV(cv.id)"
                              >
                                Công khai CV
                              </button> -->
                            </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-body">
              <ul class="body-desc">
                <li>Bạn có chắc chắn muốn bỏ lưu công việc này?</li>
              </ul>
              <button
