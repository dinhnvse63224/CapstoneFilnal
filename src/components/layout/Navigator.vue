        ...
        <div class="theme-header clearfix">
          ...
          <div class="navbar-header">
            ...
            <router-link to="" class="navbar-brand"
              ><img style="width: 20%; height: 20%;" src="assets/img/logo.png" />
            </router-link>
          </div>
          <div class="collapse navbar-collapse" id="main-navbar">
            <ul class="navbar-nav mr-auto w-100 justify-content-end">
              <li class="nav-item active" >
                <router-link class="nav-link" to="/" style="font-weight: bold;"> Trang chủ </router-link>
              </li>
              <li class="nav-item active">
                <router-link class="nav-link" to="/all" style="font-weight: bold;"> Việc làm </router-link>
              </li>
              <li class="nav-item active">
                <router-link class="nav-link" to="/contact" style="font-weight: bold;">
                  Liên Hệ
                </router-link>
              </li>
              <li
