<template>
  <div class="col-lg-6 col-md-12 col-xs-12">
    <div class="jobs-latest">
      ...
      <div class="content">
        <h3 class="job-name" style="font-weight: bold;">
        ...
        <div class="tags">
          ...
          <i class="lni-map-marker" v-if="job.location == 13"> Quận Bình Tân </i> 
          <i class="lni-map-marker" v-if="job.location == 14"> Quận Bình Thạnh </i> 
          ...
          <i class="lni-map-marker" v-if="job.location == 19"> Quận Thủ Đức </i> 
          <i class="lni-map-marker" v-if="job.location == 20"> Huyện Bình Chánh </i> 
          <i class="lni-map-marker" v-if="job.location == 21"> Huyện Cần Giờ </i> 
          <i class="lni-map-marker" v-if="job.location == 22"> Huyện Củ Chi </i> 
          <i class="lni-map-marker" v-if="job.location == 23"> Huyện Hóc Môn </i> 
          <i class="lni-map-marker" v-if="job.location == 24"> Huyện Nhà Bè </i> 
        </div>
        
        <div class="tags">Ngày hết hạn: {{ job.endDate }}</div><br>
